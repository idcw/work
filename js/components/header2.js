	        ...
	        <a class="nav-link" href="dashboard.html">Dashboard</a>
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="actionsDropdown">
						<a class="dropdown-item" href="newjob.html">Create New Job</a>
						<a class="dropdown-item" href="compare.html">Compare Candidates</a>
						<a class="dropdown-item" href="processRequest.html">Process Request</a>
					</div>
				</li>
	    </ul>
